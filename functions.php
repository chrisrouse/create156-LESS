...
//load google webfont
	wp_register_style( 'google_font_one', 'http://fonts.googleapis.com/css?family=Oswald:300,400,700' );
wp_enqueue_style( 'google_font_one' );

	wp_register_style( 'google_font_two', 'http://fonts.googleapis.com/css?family=Roboto+Slab:100,300,400,700' );
